      ...
      <div class="col-12">
        <div class="header-text">
          ...
          <p>This framework has a column based layout, you can have up to 12 columns in one row.
              Each row should add up to 12 and column sizes can be mixed. The only exception to
              this rule will be if you use the 2-5 class, which is a trick to get a 5 column layout.</p>
        </div>
      </div>
